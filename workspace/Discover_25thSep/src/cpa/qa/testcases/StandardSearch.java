...
public class StandardSearch {
	Xls_Reader xls = new Xls_Reader(System.getProperty("user.dir")+"\\src\\cpa\\qa\\xls\\StandardSearch.xlsx");

	@Test(dataProvider="getData")
		public void doStandardSearch(Hashtable<String,String> testData) throws Throwable{
		System.out.println("##teamcity[testSuiteStarted name='suite.StandardSearch']");
	
		// run-mode of test
		if(!TestUtil.getRunmode("StandardSearch", xls))
	...
	// execution
		...
		k.executeTest("StandardSearch",xls,testData);
		
		try {
			Xls_Reader xls1 = new Xls_Reader(System.getProperty("user.dir")+"\\src\\cpa\\qa\\xls\\Test Report.xlsx");
			TestUtil.getReport("StandardSearch", xls1);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		
		System.out.println("##teamcity[testSuiteFinished name='suite.StandardSearch']");
	...
	public Object[][] getData(){
			return 	TestUtil.getData("StandardSearch", xls);
	}
