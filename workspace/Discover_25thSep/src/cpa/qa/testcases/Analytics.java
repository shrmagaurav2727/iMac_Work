...
public class Analytics {
		...
		Xls_Reader xls = new Xls_Reader(System.getProperty("user.dir")+"\\src\\cpa\\qa\\xls\\Analytics.xlsx");
		
		@Test(dataProvider="getData")
			public void doAnalytics(Hashtable<String,String> testData) throws Throwable{
			System.out.println("##teamcity[testSuiteStarted name='suite.Analytics']");
			
			// run-mode of test
			if(!TestUtil.getRunmode("Analytics", xls))
			...
			k.executeTest("Analytics",xls,testData); 
			
			Xls_Reader xls1 = new Xls_Reader(System.getProperty("user.dir")+"\\src\\cpa\\qa\\xls\\Test Report.xlsx");
			TestUtil.getReport("Analytics", xls1);
			
			System.out.println("##teamcity[testSuiteFinished name='suite.Analytics']");
		...
		public Object[][] getData(){
				return 	TestUtil.getData("Analytics", xls);
		}
