...
public class History {
	Xls_Reader xls = new Xls_Reader(System.getProperty("user.dir")+"\\src\\cpa\\qa\\xls\\History.xlsx");

	@Test(dataProvider="getData")
		public void doHistory(Hashtable<String,String> testData) throws Throwable{
		System.out.println("##teamcity[testSuiteStarted name='suite.History']");
		
		// run-mode of test
		if(!TestUtil.getRunmode("History", xls))
		...
		k.executeTest("History",xls,testData); 
		
		Xls_Reader xls1 = new Xls_Reader(System.getProperty("user.dir")+"\\src\\cpa\\qa\\xls\\Test Report.xlsx");
		TestUtil.getReport("History", xls1);
		
		System.out.println("##teamcity[testSuiteFinished name='suite.History']");
	...
	public Object[][] getData(){
			return 	TestUtil.getData("History", xls);
	}
}
